...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this._appService.poseReq().subscribe(function (result) {
            console.log(result);
        });
    };
...
var AppService = (function () {
    ...
    AppService.prototype.poseReq = function () {
        var myModel = { Value: 'Brad' };
        return this._http.post(this.greetUrl, myModel).map(function (res) {
